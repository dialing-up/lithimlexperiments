...
import 'https://cdn.skypack.dev/@material/mwc-button';
customElements.define('brewery-detail', BreweryDetail);
//customElements.define('mwc-button', materialMwcButton);
...
export class BreweryApp extends LitElement{
    ...
    _toggleVisitedStatus(changedBrewery){
        this.breweries = this.breweries.map(brewery => {
            return brewery === changedBrewery ? {...brewery, visited: !brewery.visited} : brewery;
        });
    }
    _filterNone(){
        this.filter = null;
